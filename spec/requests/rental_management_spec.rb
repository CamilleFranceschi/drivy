...
RSpec.describe 'Rental Management', type: :request do
  ...
  describe "GET #index" do
    ...
    it "shows well calculated commissions" do
      ...
      rental3 = Rental.create!(car: car1, start_date: Date.new(2050, 7, 3), end_date: Date.new(2050, 7, 14), distance: 1000)
      get "/api/v1/rentals"
      expect(response.body).to include("\"price\":3000.0,\"commission\":{\"insurance_fee\":450.0,\"assistance_fee\":100.0,\"drivy_fee\":350.0}")
      expect(response.body).to include("\"price\":6800.0,\"commission\":{\"insurance_fee\":1020.0,\"assistance_fee\":200.0,\"drivy_fee\":820.0}")
      expect(response.body).to include("\"price\":27800.0,\"commission\":{\"insurance_fee\":4170.0,\"assistance_fee\":1200.0,\"drivy_fee\":2970.0}")
    end
  end
end
