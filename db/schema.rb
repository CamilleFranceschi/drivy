...
ActiveRecord::Schema.define(version: 20170626135926) do
  ...
  create_table "rental_modifications", force: :cascade do |t|
    t.date     "start_date"
    t.date     "end_date"
    t.integer  "distance"
    t.integer  "rental_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["rental_id"], name: "index_rental_modifications_on_rental_id", using: :btree
  end
